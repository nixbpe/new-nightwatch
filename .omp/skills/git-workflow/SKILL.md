...
**Before every commit:** Run the applicable quality gates in Quality scripts before reporting completion when source code changes. Documentation-only changes do not require those gates.
