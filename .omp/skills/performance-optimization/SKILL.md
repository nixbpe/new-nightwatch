...
**Do not cache:** data whose staleness is a correctness bug, or per-user data under a key that omits the user. Use file:`../../references/performance-checklist.md` for coalescing, write strategies, negative caching and the checklist.
...
For detailed performance checks and commands, use file:`../../references/performance-checklist.md`.
